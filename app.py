...
WELCOME_MESSAGE = f""" *👾/**👾**👾* Time to watch every pet in the neighborhood *👾/**👾**👾* 
\n\n
Nah!!! Let's Go COUCH SURFING Instead
\n I got just got this,
\nG-R-O-O-V-Y 
\nTime Traveling DevCie 
\n\n
Lets make them pets less of a job, 
\nmore simple a chore 
\nand get faster + better + more accuate results. 

\n\nWhich of the following 5 options interest you for agent stat markers? 
\n
\n  Getting fed stock tips from an algarythim capableof predicting next years flu season from google searches
"""
...
async def on_chat_start():
  try:
    ...
    msg = cl.Message(content=f"""This is the Parakeet, get my Sparrows flight paths scored for more/less personalized results.
    
    
    , please give instructions on how the Soap Opera should be structured and made. \n\n
